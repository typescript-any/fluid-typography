...
- `text-body-xl` = `text-xl` (20px) on desktop, scales down to 17px on mobile
- `text-body-lg` = `text-lg` (18px) on desktop, scales down to 15px on mobile
...
| **Body Text**               |
| `text-body-xl`              | 17px → 20px      | 400    | Extra large body text     |
| `text-body-lg`              | 15px → 18px      | 400    | Large body text           |
